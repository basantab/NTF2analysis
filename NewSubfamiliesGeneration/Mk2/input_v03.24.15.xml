<ROSETTASCRIPTS>
  ...
  <SCOREFXNS>
    ...
    <ScoreFunction name="scoring" weights="fldsgn_cen" >
      ...
      <Reweight scoretype="cen_pair_motif_degree" weight="20.0"/>
  ...
  <FILTERS>
    ...
    <ScoreType name="cen_pair_motif_type" scorefxn="scoring" score_type="cen_pair_motifs" threshold="1000" confidence="0"/>
    <MoveBeforeFilter name="cent_score" mover="cent" filter="cen_score_type"/>
    <MoveBeforeFilter name="cent_pair_motifs" mover="cent" filter="cen_pair_motif_type"/>
  ...
  <FILTERS>
    ...
    <SecondaryStructure name="ss2"  use_abego="1" blueprint="%%bp2%%" threshold="1.0" confidence="1" compute_pose_secstruct_by_dssp="1"/>
  ...
  <FILTERS>
    ...
    <SecondaryStructure name="ss3"  use_abego="1" blueprint="%%bp3%%" threshold="1.0" confidence="1" compute_pose_secstruct_by_dssp="1" />
  ...
  <PROTOCOLS>
    ...
    <Add filter_name="cent_pair_motifs"/>
